...
param Streams_Cost1_inv{l in Costs, s in StreamsOfLayer[l]:l='osmose_default_model_DefaultInvCost'}:= max{t in Time:s in StreamsOfTime[t]}Streams_Cost1[l,s,t];
param Streams_Cost2_inv{l in Costs, s in StreamsOfLayer[l]:l='osmose_default_model_DefaultInvCost'}:= max{t in Time:s in StreamsOfTime[t]}Streams_Cost2[l,s,t];
...
subject to streams_cost_t{l in Costs, s in StreamsOfLayer[l], u in UnitsOfStream[s],t in Time:s in StreamsOfTime[t] and l <>'osmose_default_model_DefaultInvCost'}:
...
subject to streams_cost{l in Costs, s in StreamsOfLayer[l], u in UnitsOfStream[s]:l <>'osmose_default_model_DefaultInvCost'}:
...
subject to unit_cost_t{l in Costs, u in UnitsOfLayer[l],t in Time:u in UnitsOfTime[t] and l <>'osmose_default_model_DefaultInvCost'} :
...
subject to unit_cost{l in Costs, u in UnitsOfLayer[l]:l <>'osmose_default_model_DefaultInvCost'} :
...
subject to locations_cost_t{l in Costs, loc in LocationsOfLayer[l],t in Time:l <>'osmose_default_model_DefaultInvCost'}:
...
subject to costs_cost_t{l in Costs,t in Time:l <>'osmose_default_model_DefaultInvCost'}:
	Costs_Cost_t[l,t] = sum {u in UnitsOfLayer[l]:u in UnitsOfTime[t]} Units_Cost_t[l,u,t];

#Investment cost:-----------------------------------------------------------------------

# Computing cost for each Inv stream
subject to streams_cost_inv{l in Costs, s in StreamsOfLayer[l], u in UnitsOfStream[s]:l='osmose_default_model_DefaultInvCost'}:
...
subject to unit_cost_inv{l in Costs, u in UnitsOfLayer[l]:l='osmose_default_model_DefaultInvCost'} :
...
subject to const_elec1_t{l in Costs, t in Time:l='osmose_default_model_DefaultMechPower'}:
	Costs_Cost_t[l,t] - Elec_buy_t[t]+ Elec_sell_t[t] = 0 ;

subject to const_elec2_t{l in Costs, t in Time:l='osmose_default_model_DefaultMechPower'}:
	Costs_Cost_t[l,t] - Elec_buy_t[t]  <= 0;

subject to new_opcost_t{l in Costs, t in Time:l='osmose_default_model_DefaultOpCost'}:
