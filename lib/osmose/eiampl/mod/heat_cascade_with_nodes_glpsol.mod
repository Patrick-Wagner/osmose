...
#	check {ly in HeatCascades, lc in LocationsOfLayer[ly],pn in ParentNodesOfLocation[lc]}: card(HC_HTS_Hot[ly,lc,pn]) > 0;
...
#  check {ly in HeatCascades, lc in LocationsOfLayer[ly],pn in ParentNodesOfLocation[lc]}: card(HC_HTS_Cold[ly,lc,pn]) > 0;	
...
# Heat Balance for base node Hot streams (it is necessary to calculate the exchanged heat for each temperature interval with tl and tu, not the "summed" definition)
#subject to HeatBalance_BNodes_Hot{ly in HeatCascades, lc in LocationsOfLayer[ly], n in BNodesOfLocation[lc], k in HC_TempIntervals[ly,lc],i in TK[ly,lc] diff{1},kcurent in trk_p[ly,lc,i],kpreve in trk_p[ly,lc,i-1] : k = kcurent}:
#sum{st in HC_Nodes_Hot[ly,lc,n]:Streams_Tout[ly,st]>=HC_TI_tl[ly,lc,kpreve]+epsilon} (Streams_Mcp[ly,st]*HC_Streams_Mult[ly,st]*
#    (Streams_Tin[ly,st]-Streams_Tout[ly,st])) 
#+sum{st in HC_Nodes_Hot[ly,lc,n]:Streams_Tout[ly,st]<=HC_TI_tl[ly,lc,kpreve] and Streams_Tin[ly,st]>=HC_TI_tl[ly,lc,kpreve]+epsilon}
#     (Streams_Mcp[ly,st]*HC_Streams_Mult[ly,st]*(Streams_Tin[ly,st]-HC_TI_tl[ly,lc,kpreve]))
#-sum{st in HC_Nodes_Hot[ly,lc,n]:Streams_Tout[ly,st]>=HC_TI_tl[ly,lc,k]+epsilon} (Streams_Mcp[ly,st]*HC_Streams_Mult[ly,st]*
#     (Streams_Tin[ly,st]-Streams_Tout[ly,st])) 
#-sum{st in HC_Nodes_Hot[ly,lc,n]:Streams_Tout[ly,st]<=HC_TI_tl[ly,lc,k] and Streams_Tin[ly,st]>=HC_TI_tl[ly,lc,k]+epsilon}
#     (Streams_Mcp[ly,st]*HC_Streams_Mult[ly,st]*(Streams_Tin[ly,st]-HC_TI_tl[ly,lc,k]))	 	 
#- sum{np in ParentNodeOfNode[n]} Qhtsplus[ly,lc,np,n,kpreve] + sum{np in ParentNodeOfNode[n]} Qhtsplus[ly,lc,np,n,k] 
#	 + HC_Nodes_Rk[ly,lc,n,kpreve] - HC_Nodes_Rk[ly,lc,n,k] >= 0; 	 

# Heat Balance for base node Cold streams 
#subject to HeatBalance_BNodes_Cold{ly in HeatCascades, lc in LocationsOfLayer[ly], n in BNodesOfLocation[lc], k in HC_TempIntervals[ly,lc],i in TK[ly,lc] diff{1},kcurent in trk_p[ly,lc,i],kpreve in trk_p[ly,lc,i-1] : k = kcurent}:
#- sum{st in HC_Nodes_Cold[ly,lc,n]:Streams_Tin[ly,st]>=HC_TI_tl[ly,lc,kpreve]+epsilon} 
#    (Streams_Mcp[ly,st]*HC_Streams_Mult[ly,st]*(Streams_Tout[ly,st]-Streams_Tin[ly,st]))
#- sum{st in HC_Nodes_Cold[ly,lc,n]:Streams_Tin[ly,st]<=HC_TI_tl[ly,lc,kpreve] and Streams_Tout[ly,st]>=HC_TI_tl[ly,lc,kpreve]+epsilon}
#    (Streams_Mcp[ly,st]*HC_Streams_Mult[ly,st]*(Streams_Tout[ly,st]-HC_TI_tl[ly,lc,kpreve]))	
#+ sum{st in HC_Nodes_Cold[ly,lc,n]:Streams_Tin[ly,st]>=HC_TI_tl[ly,lc,k]+epsilon} 
#   (Streams_Mcp[ly,st]*HC_Streams_Mult[ly,st]*(Streams_Tout[ly,st]-Streams_Tin[ly,st]))
#+ sum{st in HC_Nodes_Cold[ly,lc,n]:Streams_Tin[ly,st]<=HC_TI_tl[ly,lc,k] and Streams_Tout[ly,st]>=HC_TI_tl[ly,lc,k]+epsilon}
#    (Streams_Mcp[ly,st]*HC_Streams_Mult[ly,st]*(Streams_Tout[ly,st]-HC_TI_tl[ly,lc,k]))		
#+ sum{np in ParentNodeOfNode[n]} Qhtsmin[ly,lc,np,n,kpreve] - sum{np in ParentNodeOfNode[n]} Qhtsmin[ly,lc,np,n,k] 
#+ HC_Nodes_Rk[ly,lc,n,kpreve] - HC_Nodes_Rk[ly,lc,n,k] <= 0; 	 
